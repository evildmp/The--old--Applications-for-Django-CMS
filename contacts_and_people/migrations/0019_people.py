...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Building.slug'
        db.add_column('contacts_and_people_building', 'slug', orm['contacts_and_people.building:slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Building.slug'
        db.delete_column('contacts_and_people_building', 'slug')
