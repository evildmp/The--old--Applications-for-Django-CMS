...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.home_entity'
        db.delete_column('contacts_and_people_person', 'home_entity_id')
        
        # Deleting field 'Person.job_title'
        db.delete_column('contacts_and_people_person', 'job_title')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Person.home_entity'
        db.add_column('contacts_and_people_person', 'home_entity', orm['contacts_and_people.person:home_entity'])
        
        # Adding field 'Person.job_title'
        db.add_column('contacts_and_people_person', 'job_title', orm['contacts_and_people.person:job_title'])
