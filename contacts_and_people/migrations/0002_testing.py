...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.dummyfield'
        db.add_column('contacts_and_people_person', 'dummyfield', orm['contacts_and_people.person:dummyfield'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.dummyfield'
        db.delete_column('contacts_and_people_person', 'dummyfield')
    ...
    models = {
        ...
        'contacts_and_people.person': {
            'access_note': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'building': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Building']", 'null': 'True', 'blank': 'True'}),
            'dummyfield': ('django.db.models.fields.CharField', [], {'max_length': '6'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
