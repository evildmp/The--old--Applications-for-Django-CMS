...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.membership_order'
        db.add_column('contacts_and_people_membership', 'membership_order', orm['contacts_and_people.membership:membership_order'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Membership.membership_order'
        db.delete_column('contacts_and_people_membership', 'membership_order')
