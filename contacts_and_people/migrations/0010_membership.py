...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.order'
        db.add_column('contacts_and_people_membership', 'order', orm['contacts_and_people.membership:order'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Membership.order'
        db.delete_column('contacts_and_people_membership', 'order')
