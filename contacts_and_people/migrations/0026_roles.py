...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.display_role'
        db.add_column('contacts_and_people_membership', 'display_role', orm['contacts_and_people.membership:display_role'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Membership.display_role'
        db.delete_column('contacts_and_people_membership', 'display_role_id')
