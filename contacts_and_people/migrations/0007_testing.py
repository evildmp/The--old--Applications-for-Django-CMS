...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.home_entity'
        db.add_column('contacts_and_people_membership', 'home_entity', orm['contacts_and_people.membership:home_entity'])
        
        # Deleting field 'Membership.testfield'
        db.delete_column('contacts_and_people_membership', 'testfield')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Membership.home_entity'
        db.delete_column('contacts_and_people_membership', 'home_entity')
        
        # Adding field 'Membership.testfield'
        db.add_column('contacts_and_people_membership', 'testfield', orm['contacts_and_people.membership:testfield'])
    ...
    models = {
        ...
        'contacts_and_people.membership': {
            ...
            'home_entity': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
