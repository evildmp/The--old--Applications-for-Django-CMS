...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.bus_travel_information'
        db.add_column('contacts_and_people_site', 'bus_travel_information', orm['contacts_and_people.site:bus_travel_information'])
        
        # Adding field 'Site.cycle_parking'
        db.add_column('contacts_and_people_site', 'cycle_parking', orm['contacts_and_people.site:cycle_parking'])
        
        # Adding field 'Site.rail_travel_information'
        db.add_column('contacts_and_people_site', 'rail_travel_information', orm['contacts_and_people.site:rail_travel_information'])
        
        # Adding field 'Site.car_parking'
        db.add_column('contacts_and_people_site', 'car_parking', orm['contacts_and_people.site:car_parking'])
        
        # Deleting field 'Site.travel_info_rail'
        db.delete_column('contacts_and_people_site', 'travel_info_rail')
        
        # Deleting field 'Site.parking_info_bicycle'
        db.delete_column('contacts_and_people_site', 'parking_info_bicycle')
        
        # Deleting field 'Site.travel_info_bus'
        db.delete_column('contacts_and_people_site', 'travel_info_bus')
        
        # Deleting field 'Site.parking_info_car'
        db.delete_column('contacts_and_people_site', 'parking_info_car')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Site.bus_travel_information'
        db.delete_column('contacts_and_people_site', 'bus_travel_information')
        
        # Deleting field 'Site.cycle_parking'
        db.delete_column('contacts_and_people_site', 'cycle_parking')
        
        # Deleting field 'Site.rail_travel_information'
        db.delete_column('contacts_and_people_site', 'rail_travel_information')
        
        # Deleting field 'Site.car_parking'
        db.delete_column('contacts_and_people_site', 'car_parking')
        
        # Adding field 'Site.travel_info_rail'
        db.add_column('contacts_and_people_site', 'travel_info_rail', orm['contacts_and_people.site:travel_info_rail'])
        
        # Adding field 'Site.parking_info_bicycle'
        db.add_column('contacts_and_people_site', 'parking_info_bicycle', orm['contacts_and_people.site:parking_info_bicycle'])
        
        # Adding field 'Site.travel_info_bus'
        db.add_column('contacts_and_people_site', 'travel_info_bus', orm['contacts_and_people.site:travel_info_bus'])
        
        # Adding field 'Site.parking_info_car'
        db.add_column('contacts_and_people_site', 'parking_info_car', orm['contacts_and_people.site:parking_info_car'])
    ...
    models = {
        ...
        'contacts_and_people.site': {
            'bus_travel_information': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'car_parking': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'cycle_parking': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_town': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'rail_travel_information': ('django.db.models.fields.TextField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
