...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.home'
        db.add_column('contacts_and_people_membership', 'home', orm['contacts_and_people.membership:home'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Membership.home'
        db.delete_column('contacts_and_people_membership', 'home')
