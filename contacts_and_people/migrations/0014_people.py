...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.delete_column('contacts_and_people_person', 'title_id')
        
        # Changing field 'Person.given_name'
        # (to signature: django.db.models.fields.CharField(max_length=50, null=True, blank=True))
        db.alter_column('contacts_and_people_person', 'given_name', orm['contacts_and_people.person:given_name'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('contacts_and_people_person', 'title', orm['contacts_and_people.person:title'])
