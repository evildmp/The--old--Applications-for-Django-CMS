...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('contacts_and_people_building', 'longitude', orm['contacts_and_people.building:longitude'])
        
        # Adding field 'Building.latitude'
        db.add_column('contacts_and_people_building', 'latitude', orm['contacts_and_people.building:latitude'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('contacts_and_people_building', 'longitude')
        
        # Deleting field 'Building.latitude'
        db.delete_column('contacts_and_people_building', 'latitude')
