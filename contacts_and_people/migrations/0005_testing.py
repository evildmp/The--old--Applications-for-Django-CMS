...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membership.key_contact'
        db.add_column('contacts_and_people_membership', 'key_contact', orm['contacts_and_people.membership:key_contact'])
        
        # Adding field 'Membership.key_member'
        db.add_column('contacts_and_people_membership', 'key_member', orm['contacts_and_people.membership:key_member'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Membership.key_contact'
        db.delete_column('contacts_and_people_membership', 'key_contact')
        
        # Deleting field 'Membership.key_member'
        db.delete_column('contacts_and_people_membership', 'key_member')
    ...
    models = {
        ...
        'contacts_and_people.membership': {
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'membership'", 'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Person']"}),
