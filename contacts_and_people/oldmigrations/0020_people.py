...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Dropping ManyToManyField 'Role.entities'
        db.delete_table('contacts_and_people_role_entities')
    ...
    def backwards(self, orm):
        ...
        # Adding ManyToManyField 'Role.entities'
        db.create_table('contacts_and_people_role_entities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('role', models.ForeignKey(orm.Role, null=False)),
            ('entity', models.ForeignKey(orm.entity, null=False))
        ))
