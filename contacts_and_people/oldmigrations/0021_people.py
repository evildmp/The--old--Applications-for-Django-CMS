...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_and_people_entityrole', (
            ('id', orm['contacts_and_people.entityrole:id']),
            ('entity', orm['contacts_and_people.entityrole:entity']),
            ('role', orm['contacts_and_people.entityrole:role']),
            ('order', orm['contacts_and_people.entityrole:order']),
        ))
    ...
    models = {
        ...
        'contacts_and_people.entity': {
            ...
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'roles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['contacts_and_people.Role']", 'null': 'True', 'blank': 'True'}),
        ...
        'contacts_and_people.entityrole': {
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Role']"})
        },
        'contacts_and_people.membership': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bob'", 'blank': 'True', 'null': 'True', 'to': "orm['contacts_and_people.Role']"})
        },
        ...
        'contacts_and_people.role': {
            ...
            'plural_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'})
        },
