...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Dropping ManyToManyField 'Entity.roles'
        db.delete_table('contacts_and_people_entity_roles')
        
        # Deleting field 'Membership.role'
        db.delete_column('contacts_and_people_membership', 'role_id')
        
        # Deleting model 'role'
        db.delete_table('contacts_and_people_role')
        
        # Deleting model 'entityrole'
        db.delete_table('contacts_and_people_entityrole')
        
    
    
    def backwards(self, orm):
        
        # Adding ManyToManyField 'Entity.roles'
        db.create_table('contacts_and_people_entity_roles', (
        ...
        db.add_column('contacts_and_people_membership', 'role', orm['contacts_and_people.membership:role'])
        
        # Adding model 'role'
        db.create_table('contacts_and_people_role', (
            ('plural_name', orm['contacts_and_people.membership:plural_name']),
            ('id', orm['contacts_and_people.membership:id']),
            ('name', orm['contacts_and_people.membership:name']),
        ))
        db.send_create_signal('contacts_and_people', ['role'])
        
        # Adding model 'entityrole'
        db.create_table('contacts_and_people_entityrole', (
        ...
        db.send_create_signal('contacts_and_people', ['entityrole'])
    ...
    models = {
        ...
        'cms.page': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'children'", 'null': 'True', 'to': "orm['cms.Page']", 'blank': 'True'}),
            'public': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'origin'", 'unique': 'True', 'null': 'True', 'to': "orm['cms.PagePublic']", 'blank': 'True'}),
