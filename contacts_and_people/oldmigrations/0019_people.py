...
class Migration:
    ...
    models = {
        ...
        'contacts_and_people.membership': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts_and_people.Role']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'contacts_and_people.role': {
            'entities': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['contacts_and_people.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
